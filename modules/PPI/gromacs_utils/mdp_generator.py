...
class MDPConfig:
    ...
    # Energy minimization
    em_steps: int = 50000
    em_tolerance: float = 10.0  # kJ/mol/nm  (strict convergence)
    ...
    # Equilibration
    nvt_steps: int = 100000  # 200 ps
    npt_steps: int = 100000  # 200 ps
    
    # Production MD
    md_steps: int = 5000000  # 10 ns
...
; Neighbor searching
nstlist         = {cfg.nstlist}            ; Frequency to update neighbor list
...
pme_order       = 6             ; 6th-order interpolation (high accuracy)
fourierspacing  = 0.10          ; Fine PME grid spacing
...
lincs_iter      = 2             ; High-accuracy LINCS iterations
lincs_order     = 6             ; High-accuracy LINCS expansion order
